...
class JMXItemChecker extends ItemChecker
{
	...
	public JMXItemChecker(JSONObject request) throws ZabbixException
	{
		...
		try
		{
			conn = request.getString(JSON_TAG_CONN);
			port = String.valueOf(request.getInt(JSON_TAG_PORT));
	...
	public JSONArray getValues() throws ZabbixException
	{
		...
		try
		{
			...
			mbsc = JmxConnectionFactory.getMBeanServerConnection(JmxConnectionFactory.
		...
		{
			//TODO Devolver a conexao JMX pro pool
//			mbsc = null;
		}
